...
6. Pendiente: validar en Deploy Preview que las reglas de redireccion 301 funcionan realmente contra el servidor de Netlify (esto no puede verificarse en un build local), y que ninguna otra pagina cambia de URL o se rompe.
